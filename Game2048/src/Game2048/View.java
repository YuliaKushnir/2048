...
public class View extends JPanel {
    ...
    public void paint(Graphics g) {
        ...
        for (int i = 0; i < 4; i++) {
            for (int j = 0; j < 4; j++) {
                drawTile(g, controller.getGameTiles()[j][i], i, j);
            }
        }

        g.drawString("Score: " + controller.getScore(), 140, 465);

        if (isGameWon) JOptionPane.showMessageDialog(this, "You've won!");
        else if(isGameLost) JOptionPane.showMessageDialog(this, "You've lost =(");
